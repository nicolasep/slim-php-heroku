...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-04-2021 a las 01:21:57
...
CREATE TABLE `producto` (
  ...
  `frcha_de_creacion` date NOT NULL,
...
INSERT INTO `producto` (`id`, `codigo_de_barra`, `nombre`, `tipo`, `stock`, `precio`, `frcha_de_creacion`, `fecha_de_modificacion`) VALUES
