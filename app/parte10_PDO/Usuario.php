...
class Usuario
{
	...
	static function RetornarUsuariosOrdenados($orden)
	{
		$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso(); 
		
		if($orden == "DESC" || $orden == "desc")
		{
			$consulta =$objetoAccesoDato->RetornarConsulta("SELECT * FROM usuario ORDER BY nombre DESC");
		}
		else
		{
			$consulta =$objetoAccesoDato->RetornarConsulta("SELECT * FROM usuario ORDER BY nombre ");
		}
	...
	static function RetornarUsuarioPorLetra($letra)
	{
		$objetoAccesoDato = AccesoDatos::dameUnObjetoAcceso();
		$consulta =$objetoAccesoDato->RetornarConsulta("SELECT * FROM usuario WHERE nombre LIKE :letra");
		$consulta->bindValue(':letra', $letra, PDO::PARAM_STR);
		$consulta->execute();	
	...
	public function ListarUsuario()
	{
		...
		return $this->id." ".$this->nombre." ".$this->apellido." ".$this->clave." ".$this->mail." ".$this->fecha_de_registro."\n";
