...
class Producto
{
	...
	static function RetornarProductosOrdenados($orden)
	{
		...
		{
			$consulta =$objetoAccesoDato->RetornarConsulta("SELECT * FROM producto ORDER BY nombre ");
		}
	...
	{
		return  $this->id." ".$this->codigo_de_barra." ".$this->nombre." ".$this->tipo." ".$this->stock." ".$this->precio." ".$this->fecha_de_creacion." ".$this->fecha_de_modificacion."\n";
	}
